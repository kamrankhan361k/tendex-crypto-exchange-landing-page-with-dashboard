            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-6 col-lg-6 col-12">
                    <div class="intro-content">
                        <h1 class="text-dark">
                            Trade with
                            <strong class="text-primary">Tendex</strong>.
                            <br />
                    ...
                    <div class="intro-form-exchange">
                        ...
                        >
                            ...
                            <p class="mb-0">
                                1 USD ~ 0.000088 BTC
                                <a href="#"
                                    >Expected rate <br />No extra fees</a
                                >
                            </p>
            ...
            <div class="row py-lg-5 justify-content-center">
                <div class="col-xl-7">
                    <div class="section-title text-center">
                        ...
                        <p>
                            Tendex has a variety of features that make it the
                    ...
                    <div class="portfolio_list">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4>Mobile apps</h4>
                                <p>
                                    Stay on top of the markets with the Tendex
                                    app for
                                    <a href="#">Android</a>
                                    or
                                    <a href="#">iOS</a>.
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section-title text-center">
                        ...
                        <p>
                            All of our products are ready to go, easy to use and
                            offer great value to any kind of business
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="card trade-app-content">
                        <div class="card-body">
                            ...
                            <p>
                                All the power of Tendex's cryptocurrency
                                exchange, in the palm of your hand. Download the
                                Tendex mobile crypto trading app today
                            </p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="card trade-app-content">
                        <div class="card-body">
                            ...
                            <p>
                                Powerful crypto trading platform for those who
                                mean business. The Tendex crypto trading
                                experience, tailor-made for your Windows or
                                MacOS device.
                            </p>
                ...
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="card trade-app-content">
                        <div class="card-body">
                            ...
                            <p>
                                The Tendex API is designed to provide an easy
                                and efficient way to integrate your trading
                                ...
                                <div class="col-xl-6 col-lg-6">
                                    <div class="customer-review">
                                        ...
                                        <p>
                                            ...
                                            voluptas dignissimos similique quas
                                            molestiae doloribus recusandae
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    <div class="section-title text-center">
                        ...
                        <p>
                            Here are a few reasons why you should choose Tendex
                        </p>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4">
                    <div class="promo-content">
                        ...
                        <p>
                            Tendex supports a variety of the most popular
                            digital currencies.
                        </p>
                        <a href="#"
                            >Explore <i class="bi bi-arrow-right-short"></i
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-7 col-lg-6 col-md-6">
                    <div class="appss-content">
                        ...
                        <ul>
                            <li>
                                <i class="la la-check"></i> All your digital
                                assets in one place
                            </li>
                            <li>
                                <i class="la la-check"></i> Use Decentralized
                                Apps
                            </li>
                            <li>
                                <i class="la la-check"></i> Pay friends, not
                                addresses
                            </li>
                        </ul>
                        <div class="mt-4">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="get-touch-content">
                        ...
                        <h4>24 / 7 Support</h4>
                        <p>
                            Got a problem? Just get in touch. Our support team
                            is available 24/7.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="get-touch-content">
                        ...
                        <h4>Tendex Blog</h4>
                        <p>
                            News and updates from the world’s leading
                ...
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="get-touch-content">
                        ...
                        <h4>Careers</h4>
                        <p>
                            Help build the future of technology. Start your new
                            career at Tendex.
                        </p>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="get-touch-content">
                        ...
                        <h4>Community</h4>
                        <p>
                            Tendex is global. Join the discussion in our
