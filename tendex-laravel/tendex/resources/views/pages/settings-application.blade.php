<x-dashboard.settings-layout pageTitle="Application">
     <div class="card-body">
          <div class="row">
                          ...
                          <form action="#">
                              <div class="col-lg-6">
                                  <div class="form-check form-switch mb-3">
                                      ...
                                      <label class="form-check-label" for="s1">I send or receive
                                          digital currency</label>
                                  </div>
                                  <div class="form-check form-switch mb-3">
                                      <input class="form-check-input" type="checkbox" id="s2" checked>
                                      <label class="form-check-label" for="s2">I receive merchant
                                          order</label>
                                  </div>
                                  <div class="form-check form-switch mb-3">
                                      <input class="form-check-input" type="checkbox" id="s3" checked>
                                      <label class="form-check-label" for="s3">There are
